...
import { BookOpen, Bot, BarChart3, Clapperboard, Film, Rocket, Sparkles } from 'lucide-react';
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <p className="text-muted-foreground text-sm">
                Follows the automation flow: script → characters → storyboard → scenes → voice →
                subtitles → render → publish.
              </p>
            </CardContent>
          </Card>
        </div>

        <AiJobStatusPanel jobs={projectJobs} />
      </div>
    </div>
  );
}
